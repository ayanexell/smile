    ...
    <div class="bg-white dark:bg-stone-900 border-b border-stone-200 dark:border-stone-800 px-5 py-3.5">
        <div class="max-w-screen-xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <h1 class="font-display text-xl font-semibold text-stone-800 dark:text-stone-100">{{ __("Daftar Admin") }}</h1>
                <p class="text-xs text-stone-500 dark:text-stone-400 mt-0.5">{{ __("Kelola semua akun admin sistem SMILE") }}</p>
            </div>
            <a href="#"
