    ...
    <div class="border-b border-stone-200 bg-white px-5 py-3.5 dark:border-stone-800 dark:bg-stone-900">
        <div class="mx-auto flex max-w-7xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="font-display text-xl font-semibold text-stone-800 dark:text-stone-100">Laporan Inventaris
                </h1>
                <p class="mt-0.5 text-xs text-stone-500 dark:text-stone-400">Kelola semua Laporan Invenataris Departemen
                </p>
            </div>
        </div>
    </div>
