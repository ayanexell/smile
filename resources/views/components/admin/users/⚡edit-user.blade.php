...
<div>
    <flux:modal name="edit-user-modal" class="w-full p-4">
        {{-- Form Submit diarahkan ke method updateUser di komponen Livewire --}}
        <form wire:submit.prevent="updateUser" class="space-y-4">
            ...
            @island(lazy: true)
                ...
                <div class="relative">
                    ...
                    {{-- Indikator Loading khusus saat method editUser berjalan --}}
