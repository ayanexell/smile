    ...
    <section class="grid-pattern relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-16">
        ...
        <div class="relative z-10 mx-auto w-full max-w-lg text-center">
            ...
            <a wire:navigate
                ...
                <div class="min-w-0">
                    <div class="error-logo-name">SMILE</div>
                    <div class="error-logo-sub">Sistem Manajemen Inventaris</div>
                </div>
            </a>
            ...
            <div class="opacity-0-init animate-fade-up flex flex-col justify-center gap-3 delay-500 sm:flex-row">
                ...
                <button type="button" onclick="window.history.back()"
                    class="inline-flex items-center justify-center gap-2.5 rounded-xl border border-stone-300 px-5 py-2 text-sm font-medium text-stone-700 transition-all duration-200 hover:-translate-y-0.5 hover:bg-stone-100 dark:border-stone-700 dark:text-stone-300 dark:hover:bg-stone-800">
